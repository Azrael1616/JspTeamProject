...
<body>
        ...
        <div>
			<img id="selectone" src="../images/login.png" width="50" height="50" onclick="location.href='loginForm.jsp'">
			<img id="selecttwo" src="../images/signup.png" width="50" height="50" onclick="location.href='insertForm.jsp'">
		</div>
        <div>
