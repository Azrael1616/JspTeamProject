...
<h2>게시글 수정</h2>
	...
	<table style="border:1px solid; border-collapse:collapse; margin-left:auto; margin-right:auto;">
		<tr style="border : solid 1px;">
			<td style="border:1px solid;"><textarea style="width:100%; border:0; resize:none;"rows="20" cols="104.7" name="txtarea"><%=dto.getTxtarea()%></textarea></td>
		</tr>
	</table>
	
	<div>
		<input type="submit" class="btn btn-primary"style="position:absolute;top:610px;left:680px;"value="변경"></input>
		<button type="button" class="btn btn-primary"style="position:absolute;top:610px;left:750px;" onclick="location.href='boarddeletePro.jsp?id=<%=id%>'">삭제</button>
		<button type="button" class="btn btn-primary"style="position:absolute;top:610px;left:830px;" onclick="location.href='boardlist.jsp'">돌아가기</button>
	</div>
	</form>
</body>